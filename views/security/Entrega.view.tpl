<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Entrega&act={{act}}&cod={{hoodCod}}"
            method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="hoodShippingFee"
                    id="hoodShippingFee" placeholder="Costo de Envio" value="{{hoodShippingFee}}" {{readonly}}>
            </div>

            <div class="single-input row">
                <label for="hoodState">Estado</label><br>
                <select class="col-s-12 col-m-11 col-12 no-padding" name="hoodState" id="hoodState" {{if readonly}}
