<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Manejo&act={{act}}&cod={{codManagement}}"
            method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" disabled readonly="readonly" type="text"
                    name="codManagement" id="codManagement" placeholder="Codigo de Horario" value="{{codManagement}}"
                    {{readonly}}>
            </div>
            {{endifnot insert}}
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="hourStart" id="hourStart" {{if readonly}}
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="hourEnd" id="hourEnd" {{if readonly}}
                    readonly="readonly" disabled {{endif readonly}}>
                    {{foreach hourEnd}}
                    <option value="{{hour}}" {{selected}}>{{hour}}</option>
                    {{endfor hourEnd}}
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="maxOrderManagement"
                    id="maxOrderManagement" placeholder="Limite de Ordenes por Hora" value="{{maxOrderManagement}}"
                    {{maxOrderManagement}}>
            </div>
