<div class="page-single" style="height:200vh;">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Producto&act={{act}}&cod={{prdCod}}" method="POST"
            ...
            <div class="single-input row">
                <br>
                <label class="left" for="prdDscES">Nombre de Producto</label><br>
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="hidden" name="prdDscEN" id="prdDscEN"
                    placeholder="Nombre del Producto" value=" " {{readonly}}>
            ...
            <div class="single-buttons col-offset-s-2 col-offset-m-4 col-12 col-offset-2 no-padding">
