    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Tipo&act={{act}}&cod={{typeCod}}" method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="typeCod" id="typeCod"
                    placeholder="Codigo de Usuario" value="{{typeCod}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Tipo de Usuario</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="typeDsc" id="typeDsc"
                    placeholder="Tipo de Usuario" value="{{typeDsc}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <label for="typeState">Estado</label><br>
                <select class="col-s-12 col-m-11 col-12 no-padding" name="typeState" id="typeState" {{if readonly}}
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="datetime" name="typeExp" id="typeExp"
                    placeholder="Fecha de Expiracion" value="{{typeExp}}" {{readonly}}>
            </div>
